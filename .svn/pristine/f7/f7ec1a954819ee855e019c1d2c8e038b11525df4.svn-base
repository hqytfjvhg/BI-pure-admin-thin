    ...
    <el-row :gutter="24" justify="space-around" type="flex" class="onecharts">
      ...
      >
        <el-card class="bar-card" shadow="never">
          <h4 class="h4-style">
            {{ t("monthly.title1") }}
            <span style="color: #62c23a" class="title-span"
              >{{ t("salesBoard.common.dateStr")
              }}{{
                locale === "zh"
                  ? now + "-" + lastMonth + "-" + "01"
                  : transformDate(now + "-" + lastMonth + "-" + "01")
              }}~{{ dateEnd }}</span
            >
          </h4>
            ...
            <span style="color: #62c23a" class="title-span"
              >{{ t("salesBoard.common.dateStr")
                ...
                locale === "zh"
                  ...
                  : transformDate(new Date().getFullYear() + "-01-01")
              }}~{{
                locale === "zh"
...
const getLastDayOfPreviousMonth = () => {
  ...
  return locale.value === "zh"
    ? `${now}-${lastMonth}-${lastDay}`
    : `${lastDay}/${lastMonth}/${now}`;
};
let dateEnd = getLastDayOfPreviousMonth();
