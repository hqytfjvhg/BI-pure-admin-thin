  ...
  <div>
    ...
    >
      ...
      <template #funButton>
        ...
        <el-tooltip
          :content="t('permission.budget.downReg')"
          placement="top"
          effect="light"
        >
      ...
      <template #columns>
        ...
        <el-table-column
          prop="total"
          :label="t('permission.budget.total')"
          min-width="115"
        />
        <el-table-column
          ...
          item.map((item1, index1) => {
            ...
            if (index1 !== 0) {
              budget.value.push({
                ...
                month: monthList[index1 - 1],
                forecast:
                  item1 === null || typeof item[index1] == "string"
                    ? 0
                    : item[index1],
